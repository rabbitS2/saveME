                  ...
                  <ul class="topnav-right">
                     ...
                     <c:choose>
                     	<c:when test="${empty principal}">
                  		   <li class="login-reg"><a href="/saveME/auth/loginForm">로그인</a> | <a href="/saveME/auth/joinSelect">회원가입</a> </li>
                     	</c:when>
                     	<c:otherwise>
                  		   <li class="login-reg"><a href="/saveME/user/updateForm">회원정보</a> | <a href="/saveME/logout">로그아웃</a> </li>
                     	</c:otherwise>
                     </c:choose>
                  </ul>
               </div>
